    ...
    if (!this.firstPick || this.secondPick) {
      ...
      if (this.firstPick.title === tile.title) {
        ...
        if(this.unmatchedPairs == 0) {
          $('.message span').html('恭喜你贏了！獲得愛情摩天輪一座！');
          $('#bgsong').html('<iframe width="350" height="263" src="https://www.youtube.com/embed/1IrcyOpE2Lc?autoplay=1&loop=1&playlist=1IrcyOpE2Lc&rel=0" allow="autoplay; encrypted-media" frameborder="0" allowfullscreen></iframe>');
...
Game.MESSAGE_CLICK = '來來來翻一張，看看韓國魚後面是什麼';
Game.MESSAGE_ONE_MORE = '來來來，再看看另一條韓國魚～'
Game.MESSAGE_MISS = '可惜RRR，再選錯韓國魚要噴汁了！';
